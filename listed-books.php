...
{               ?>  
<div class="col-md-4" style="float:left; height:350px;">   


                                   
                                        
<img src="admin/bookimg/<?php echo htmlentities($result->bookImage);?>" width="90">
                                               <br /><b><?php echo htmlentities($result->BookName);?></b><br />
                                              <b>Category</b> : <?php echo htmlentities($result->CategoryName);?><br />
                                           <b>Author</b> :<?php echo htmlentities($result->AuthorName);?><br />
                                           <b>ISBN NO </b>:<?php echo htmlentities($result->ISBNNumber);?><br />
